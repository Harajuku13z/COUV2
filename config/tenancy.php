...
return [
    ...
    'database' => [
         ...
         */
        'template_tenant_connection' => env('TENANCY_DATABASE_TEMPLATE_CONNECTION', 'mysql'),
    ...
    'filesystem' => [
        ...
        'root_override' => [
            ...
            'tenant_public' => '%storage_path%/app/tenant/public/',
            'tenant_private' => '%storage_path%/app/tenant/private/',
        ],
