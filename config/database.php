    ...
    */
    ...
    'connections' => [
        ...
        'central' => [
            ...
            'database' => env('DB_DATABASE', 'artisan_seo_central'),
        ...
        'tenant' => [
            ...
            'unix_socket' => env('DB_SOCKET', ''),
            'charset' => env('TENANCY_DB_CHARSET', env('DB_CHARSET', 'utf8mb4')),
            'collation' => env('TENANCY_DB_COLLATION', env('DB_COLLATION', 'utf8mb4_unicode_ci')),
            'prefix' => '',
            'prefix_indexes' => true,
            'strict' => true,
            'engine' => null,
