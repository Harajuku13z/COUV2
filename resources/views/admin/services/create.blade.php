...
<div class="space-y-6">
    ...
    <div>
        ...
        <h1 class="text-2xl font-bold text-slate-900">Créer un service</h1>
    </div>
        ...
        <div class="rounded-[2rem] bg-white p-6 shadow-sm space-y-5">
            ...
            <div>
                ...
                <textarea id="description" name="description" rows="4"
                          ...
                          class="w-full rounded-2xl border border-slate-200 px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-slate-300">{{ old('description') }}</textarea>
            </div>
